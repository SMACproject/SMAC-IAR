...
extern void uart0Send(unsigned short* uartTxBuf, unsigned short uartTxBufLength);

extern void uart1Send(unsigned short* uartTxBuf, unsigned short uartTxBufLength);
